...
set output "demo_FixedGatesDigital0xFE_002_A000_xfer_model_QS2_DigiJQ.eps"
...
set format x ""    
set xlabel '00000001'
set arrow from 0.020804504976489606,0.001 to 0.020804504976489606,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 6.8005444178412855,0.001 to 6.8005444178412855,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.0
ymax = 100.0
K = 0.05
n = 3.0
