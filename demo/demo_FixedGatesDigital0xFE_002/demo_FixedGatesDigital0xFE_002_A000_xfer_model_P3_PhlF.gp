...
set output "demo_FixedGatesDigital0xFE_002_A000_xfer_model_P3_PhlF.eps"
...
set format x ""    
set xlabel '11101110'
set arrow from 0.02034545655273993,0.001 to 0.02034545655273993,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 6.798657367605926,0.001 to 6.798657367605926,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.02
ymax = 6.8
K = 0.23
n = 4.2
