...
set output "demo_FixedGates0xFE_002_A000_xfer_model_B3_BM3R1.eps"
...
set format x ""    
set xlabel '00000101'
set arrow from 0.1797076381418105,0.001 to 0.1797076381418105,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.6060344668551934,0.001 to 2.6060344668551934,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.01
ymax = 0.8
K = 0.26
n = 3.4
