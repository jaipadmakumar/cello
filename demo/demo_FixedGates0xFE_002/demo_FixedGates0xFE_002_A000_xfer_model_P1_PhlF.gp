...
set output "demo_FixedGates0xFE_002_A000_xfer_model_P1_PhlF.eps"
...
set format x ""    
set xlabel '11111010'
set arrow from 0.010311912257466803,0.001 to 0.010311912257466803,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 0.6248575718933977,0.001 to 0.6248575718933977,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.01
ymax = 3.9
K = 0.03
n = 4.0
