...
set output "SimAnnealing_1-alu_A000_xfer_model_P3_PhlF.eps"
...
set format x ""    
set xlabel '10010000'
set arrow from 0.04835377853082412,0.001 to 0.04835377853082412,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 1.6948644408169635,0.001 to 1.6948644408169635,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.02
ymax = 6.8
K = 0.23
n = 4.2
