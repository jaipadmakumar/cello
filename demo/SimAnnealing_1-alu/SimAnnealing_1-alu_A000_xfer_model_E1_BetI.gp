...
set output "SimAnnealing_1-alu_A000_xfer_model_E1_BetI.eps"
...
set format x ""    
set xlabel '00010001'
set arrow from 0.2939742358850441,0.001 to 0.2939742358850441,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 3.828643303087947,0.001 to 3.828643303087947,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.07
ymax = 3.8
K = 0.41
n = 2.4
