...
set output "SimAnnealing_1-alu_A000_xfer_model_R1_PsrA.eps"
...
set format x ""    
set xlabel '00100010'
set arrow from 0.07549172705531736,0.001 to 0.07549172705531736,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.872091727055317,0.001 to 2.872091727055317,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.2
ymax = 5.9
K = 0.19
n = 1.8
