...
set output "SimAnnealing_1-alu_A000_xfer_model_J2_DigiJ.eps"
...
set format x ""    
set xlabel '01101001'
set arrow from 0.021722190557234133,0.001 to 0.021722190557234133,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 6.792924120488145,0.001 to 6.792924120488145,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.0
ymax = 100.0
K = 0.05
n = 3.0
