...
set output "SimAnnealing_1-alu_A000_xfer_model_S2_SrpR.eps"
...
set format x ""    
set xlabel '01000100'
set arrow from 0.011544379516870009,0.001 to 0.011544379516870009,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 0.8012996882935028,0.001 to 0.8012996882935028,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.003
ymax = 2.1
K = 0.04
n = 2.6
