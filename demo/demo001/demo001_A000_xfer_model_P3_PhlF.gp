...
set output "demo001_A000_xfer_model_P3_PhlF.eps"
...
set format x ""    
set xlabel '0001'
set arrow from 0.07522561396914379,0.001 to 0.07522561396914379,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.1719318630438886,0.001 to 2.1719318630438886,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.02
ymax = 6.8
K = 0.23
n = 4.2
