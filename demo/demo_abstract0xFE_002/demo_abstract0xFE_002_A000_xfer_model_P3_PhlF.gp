...
set output "demo_abstract0xFE_002_A000_xfer_model_P3_PhlF.eps"
...
set format x ""    
set xlabel '11111010'
set arrow from 0.13021563337830175,0.001 to 0.13021563337830175,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.7384223852878615,0.001 to 2.7384223852878615,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.02
ymax = 6.8
K = 0.23
n = 4.2
