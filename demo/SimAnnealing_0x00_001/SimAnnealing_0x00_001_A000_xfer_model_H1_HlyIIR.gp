...
set output "SimAnnealing_0x00_001_A000_xfer_model_H1_HlyIIR.eps"
...
set format x ""    
set xlabel '11000000'
set arrow from 0.09591465544089696,0.001 to 0.09591465544089696,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.5753015759000926,0.001 to 2.5753015759000926,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.07
ymax = 2.5
K = 0.19
n = 2.6
