...
set output "SimAnnealing_0x00_001_A000_xfer_model_R1_PsrA.eps"
...
set format x ""    
set xlabel '00111100'
set arrow from 0.14767532474607917,0.001 to 0.14767532474607917,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 3.7492997237163235,0.001 to 3.7492997237163235,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.2
ymax = 5.9
K = 0.19
n = 1.8
