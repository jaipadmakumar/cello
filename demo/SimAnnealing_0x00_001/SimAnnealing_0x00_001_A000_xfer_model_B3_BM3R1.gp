...
set output "SimAnnealing_0x00_001_A000_xfer_model_B3_BM3R1.eps"
...
set format x ""    
set xlabel '00101010'
set arrow from 0.07616514632963083,0.001 to 0.07616514632963083,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.151923355936847,0.001 to 2.151923355936847,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.01
ymax = 0.8
K = 0.26
n = 3.4
