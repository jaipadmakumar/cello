...
set output "demo_FixedGatesDigital0x00_001_A000_xfer_model_P1_PhlF.eps"
...
set format x ""    
set xlabel '00000001'
set arrow from 0.020981681996460454,0.001 to 0.020981681996460454,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 4.100856446529399,0.001 to 4.100856446529399,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.01
ymax = 3.9
K = 0.03
n = 4.0
