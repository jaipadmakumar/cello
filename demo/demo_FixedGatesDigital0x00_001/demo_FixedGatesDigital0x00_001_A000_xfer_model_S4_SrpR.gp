...
set output "demo_FixedGatesDigital0x00_001_A000_xfer_model_S4_SrpR.eps"
...
set format x ""    
set xlabel '11101110'
set arrow from 0.07734933082915885,0.001 to 0.07734933082915885,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 4.238383422904121,0.001 to 4.238383422904121,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.007
ymax = 2.1
K = 0.1
n = 2.8
