...
set output "demo_FixedGatesDigital0x00_001_A000_xfer_model_P3_PhlF.eps"
...
set format x ""    
set xlabel '00000001'
set arrow from 0.030004588409125038,0.001 to 0.030004588409125038,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 3.8984120236167943,0.001 to 3.8984120236167943,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.02
ymax = 6.8
K = 0.23
n = 4.2
