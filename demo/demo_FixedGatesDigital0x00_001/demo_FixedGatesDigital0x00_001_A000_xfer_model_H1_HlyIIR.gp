...
set output "demo_FixedGatesDigital0x00_001_A000_xfer_model_H1_HlyIIR.eps"
...
set format x ""    
set xlabel '00010001'
set arrow from 0.18227320212457332,0.001 to 0.18227320212457332,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.264016554781469,0.001 to 2.264016554781469,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.07
ymax = 2.5
K = 0.19
n = 2.6
