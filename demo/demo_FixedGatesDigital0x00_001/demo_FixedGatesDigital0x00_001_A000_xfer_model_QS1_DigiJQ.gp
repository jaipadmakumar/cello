...
set output "demo_FixedGatesDigital0x00_001_A000_xfer_model_QS1_DigiJQ.eps"
...
set format x ""    
set xlabel '11101110'
set arrow from 0.014755635171312603,0.001 to 0.014755635171312603,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.394575850334684,0.001 to 2.394575850334684,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.0
ymax = 100.0
K = 0.05
n = 3.0
