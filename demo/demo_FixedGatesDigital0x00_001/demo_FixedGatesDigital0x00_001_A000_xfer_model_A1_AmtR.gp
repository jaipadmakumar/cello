...
set output "demo_FixedGatesDigital0x00_001_A000_xfer_model_A1_AmtR.eps"
...
set format x ""    
set xlabel '00010001'
set arrow from 0.0031468447529685913,0.001 to 0.0031468447529685913,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 1.2457441836735461,0.001 to 1.2457441836735461,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.06
ymax = 3.8
K = 0.07
n = 1.6
