...
set output "demo_FixedGatesDigital0xFE_005_A000_xfer_model_P3_PhlF.eps"
...
set format x ""    
set xlabel '11101110'
set arrow from 0.02035163126788547,0.001 to 0.02035163126788547,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 6.7997614863725575,0.001 to 6.7997614863725575,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.02
ymax = 6.8
K = 0.23
n = 4.2
