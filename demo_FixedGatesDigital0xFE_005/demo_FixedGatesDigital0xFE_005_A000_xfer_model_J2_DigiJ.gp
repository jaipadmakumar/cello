...
set output "demo_FixedGatesDigital0xFE_005_A000_xfer_model_J2_DigiJ.eps"
...
set format x ""    
set xlabel '00000001'
set arrow from 0.020804501900624047,0.001 to 0.020804501900624047,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 6.800544091919846,0.001 to 6.800544091919846,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.0
ymax = 100.0
K = 0.05
n = 3.0
